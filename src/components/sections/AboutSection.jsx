...
export function AboutSection() {
  ...
  return (
    <section id="about" className="py-24 bg-background relative overflow-hidden diamond-sparkle">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center mb-20">
          ...
          <h2 className="text-4xl md:text-6xl font-bold mb-8 text-balance animate-fade-in-up delay-200">
            <span className="text-primary font-bold">Almaz Bur</span> kompaniyasi haqida
          </h2>
          <p className="text-xl text-muted-foreground text-pretty leading-relaxed animate-fade-in-up delay-300">
            Biz professional olmosli burg'ulash va beton kesish sohasida ixtisoslashganmiz. Bizning jamoamiz ko'p yillik
            tajribaga ega va har qanday murakkablikdagi ishlarni sifat kafolati bilan bajarish uchun zamonaviy
            uskunalardan foydalanadi.
          </p>
        </div>
                ...
                <CardContent className="pt-0">
                  <div className="relative mb-6">
                    ...
                    <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 bg-slate-700/90 backdrop-blur-sm px-3 py-1 rounded-full border border-primary/30 shadow-lg">
                      <span className="text-lg font-bold text-primary">{advantage.metric}</span>
                      <span className="text-xs text-slate-200 ml-1">{advantage.unit}</span>
                    </div>
                  </div>
